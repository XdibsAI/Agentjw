...
class VideoRendererTool:
    ...
    def render(self, package: Dict, project_dir: Path, voice: str = DEFAULT_VOICE) -> Path:
        ...
        for i, text in enumerate(segments):
            ...
            if not (
                image_path.exists()
                and image_path.stat().st_size > 50000
            ):
